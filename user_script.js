...
(function() {
            ...
            if (element) {
                ...
                if (value) {
                    ...
                    xhr.onload = function() {
                        ...
                        //   // ========解析开始======== \\
                        if (json.data.question.list[0].analysis[0] != undefined) {analysis = json.data.question.list[0].analysis[0]}
                        else {
                            if (data.question.list[0].childList[0].analysis[0] != undefined) {analysis = "(1)"+data.question.list[0].childList[0].analysis[0]}
                            if (data.question.list[0].childList[1].analysis[0] != undefined) {analysis += "(2)"+data.question.list[0].childList[1].analysis[0]}
                            if (data.question.list[0].childList[2].analysis[0] != undefined) {analysis += "(3)"+data.question.list[0].childList[2].analysis[0]}
                            if (data.question.list[0].childList[3].analysis[0] != undefined) {analysis += "(4)"+data.question.list[0].childList[3].analysis[0]}
                        };
                        //   \\ ========解析结束======== //
    ...
    <div class="tooltip tooltip1">
        ...
        <div class="tooltiptext"><p>Release 1.0</p><p>Developed By 老班长</p></div>
    </div></div>`;
